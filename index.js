...
client.on("messageCreate", message => {
  ...
  const botMsg = `\n\n**(I am a bot, and this action was performed automatically. Please contact ${creator.tag} the moderators of this sub if you have any questions or concerns.)**`;
    ...
    var manualPhoto = "\n\n\nPhoto Tracker Bot Commands [Track photo uploads in your server!]\n[!mystats] - View your photo upload statistics.\n[!photostats @user] - View photo statistics for a specific user.\n[!toposters] - View the top photo contributors leaderboard.\n[!serverstats] - View overall server photo statistics.\n[!channelstats] - View photo statistics for current channel.\n\n**Note:** Bot automatically tracks image uploads!"
